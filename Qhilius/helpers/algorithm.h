...
inline bool AABB_Collision(GameObject &obj1, GameObject &obj2) {
    return  obj1.rect.x < obj2.rect.right + obj2.rect.width &&
...
inline std::pair<std::string, std::string> collisionSide(GameObject &obj1, GameObject &obj2) {
    const float obj1B_obj2T = abs(obj1.rect.bottom - obj2.rect.y );
    ...
    const float obj1R_obj2L = abs(obj1.rect.right - obj2.rect.x );
